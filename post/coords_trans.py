...
Project: PyProject
Creator: SF
Create time: 2021-05-25 19:31
IDE: PyCharm
Introduction: 坐标转换工具类
"""
import math
...
class CoordinateTransform:
    ...
    @classmethod
    def bd09_to_wgs84(cls, bd_lng, bd_lat):
        """
        百度09坐标系转 GPS84坐标系
        :param bd_lon:
        :param bd_lat:
        :return:
        """
        lon, lat = cls.bd09_to_gcj02(bd_lng, bd_lat)
    ...
    def wgs84_to_bd09(cls, lng, lat):
        ...
        :return:
        """
        lon, lat = cls.wgs84_to_gcj02(lng, lat)
    ...
    # gcj02经纬度坐标>墨卡托坐标
    @classmethod
    def lonLat2Mercator(cls, lng: float, lat: float):
        """
        :param longitude:
        :param latitude:
        :return: 国测局02坐标(火星坐标) 转 墨卡托坐标x,y
        """
    ...
    # 墨卡托坐标>gcj02经纬度坐标
    @classmethod
    def Mercator2lonLat(cls, mercator_x, mercator_y):
    ...
    # 墨卡托坐标>计算瓦片坐标(瓦片编号坐标) y代表地图缩放级别
    @classmethod
    def wmc2tile(cls, x, y, z=15):
        """
        :param x: mercator_x 坐标
        :param y: mercator_y 坐标
        :param z: 瓦片坐标缩放层级
        :return:
        """
        unit = 40075016.68 / math.pow(2, z)
        tx = int(((x + 20037508.34) / unit))
        ty = int(((20037508.34 - y) / unit))
        return [tx, ty, z]
